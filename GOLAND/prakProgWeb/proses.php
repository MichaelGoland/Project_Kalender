    ...
    if ($_POST){
        ...
        if($id_event == null){
            ...
            if(isset($_FILES)){
                ...
                $sql = "UPDATE isi set tgl_mulai = \"$tglMulai\" , tgl_selesai = \"$tglSelesai\", wkt_mulai = \"$wktMulai\" , wkt_selesai = \"$wktSelesai\", level_Kepentingan = \"$levelKepentingan\" , lokasi = \"$lokasi\" where id = \"$id_event\"";
                ...
                $sql = "UPDATE isi set tgl_mulai = \"$tglMulai\" , tgl_selesai = \"$tglSelesai\", wkt_mulai = \"$wktMulai\" , wkt_selesai = \"$wktSelesai\", level_Kepentingan = \"$levelKepentingan\" , lokasi = \"$lokasi\" , gambar_kegiatan = \"null\" where id = \"$id_event\"";
